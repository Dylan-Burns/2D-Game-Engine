/**
 * the purpose of this class is to properly manage all sound effects in the game in response to collision checks,
 * user input, game objectives, and static sound
 */
...
public class SoundManager {
    ...
    public void playTimeWarning() {
        Clip clip = getClip(loadAudio("timeWarning"));
        clip.start();
    }

    public void playPowerUpAppears() {
        Clip clip = getClip(loadAudio("powerUpAppears"));
        clip.start();
    }
}
