/*
* the purpose of this class is to manage the current state of the map: update location of game objects, reset the map
* after death, rendering initial map state, updating UI (score, remaining lives, time left, game status: -active-paused-inactive-),
* collision checks, collision response/update, and object validity (render or remove object dependent on collision interaction)
* */
package manager;
...
public class MapManager {
    ...
    // when mario dies the map is reset, but the UI updates itself with
    // time left , life count after death, same score. original mario state
