/**
 * the purpose of this class is to manage the UI while the game status is active (or save the state while paused)
 * (i.e. timer, life count, score, map version, pause screen, game over screen, start screen (start game, help, about)
 * and victory screen
 */
package view;
