package model;
/*
 * the purpose of this class is to create the Map object enabling the other game components to interact
 * and manipulate within the map while the game status is active
 */
